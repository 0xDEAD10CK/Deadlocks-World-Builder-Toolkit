import random
from modules.magic_tables import *
from modules.gem_tables import *
from modules.art_tables import *
...
def generate_hoard_cr_17_plus():
    coins = {
        "gp": random.randint(1, 12) * 1000,
        "pp": random.randint(1, 8) * 1000
    }
    ...
    if 3 <= gems_or_art_objects_roll <= 5:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        magic_items.extend([roll_magic_item_table_c() for _ in range(random.randint(1, 8))])
    elif 6 <= gems_or_art_objects_roll <= 8:
        art_objects = [roll_2500_gp_art_object() for _ in range(random.randint(1, 10))]
        magic_items.extend([roll_magic_item_table_c() for _ in range(random.randint(1, 8))])
    elif 9 <= gems_or_art_objects_roll <= 11:
        art_objects = [roll_7500_gp_art_object() for _ in range(random.randint(1, 4))]
        magic_items.extend([roll_magic_item_table_c() for _ in range(random.randint(1, 8))])
    elif 12 <= gems_or_art_objects_roll <= 14:
        gems = [roll_5000_gp_gemstone() for _ in range(random.randint(1, 8))]
        magic_items.extend([roll_magic_item_table_c() for _ in range(random.randint(1, 8))])
    elif 15 <= gems_or_art_objects_roll <= 22:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        magic_items.extend([roll_magic_item_table_d() for _ in range(random.randint(1, 6))])
    elif 23 <= gems_or_art_objects_roll <= 30:
        art_objects = [roll_2500_gp_art_object() for _ in range(random.randint(1, 10))]
        magic_items.extend([roll_magic_item_table_d() for _ in range(random.randint(1, 6))])
    elif 31 <= gems_or_art_objects_roll <= 38:
        art_objects = [roll_7500_gp_art_object() for _ in range(random.randint(1, 4))]
        magic_items.extend([roll_magic_item_table_d() for _ in range(random.randint(1, 6))])
    elif 39 <= gems_or_art_objects_roll <= 46:
        gems = [roll_5000_gp_gemstone() for _ in range(random.randint(1, 8))]
        magic_items.extend([roll_magic_item_table_d() for _ in range(random.randint(1, 6))])
    elif 47 <= gems_or_art_objects_roll <= 52:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        magic_items.extend([roll_magic_item_table_e() for _ in range(random.randint(1, 6))])
    elif 53 <= gems_or_art_objects_roll <= 58:
        art_objects = [roll_2500_gp_art_object() for _ in range(random.randint(1, 10))]
        magic_items.extend([roll_magic_item_table_e() for _ in range(random.randint(1, 6))])
    elif 59 <= gems_or_art_objects_roll <= 63:
        art_objects = [roll_7500_gp_art_object() for _ in range(random.randint(1, 4))]
        magic_items.extend([roll_magic_item_table_e() for _ in range(random.randint(1, 6))])
    elif 64 <= gems_or_art_objects_roll <= 68:
        gems = [roll_5000_gp_gemstone() for _ in range(random.randint(1, 8))]
        magic_items.extend([roll_magic_item_table_e() for _ in range(random.randint(1, 6))])
    elif gems_or_art_objects_roll == 69:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        magic_items.extend([roll_magic_item_table_g() for _ in range(random.randint(1, 4))])
    elif gems_or_art_objects_roll == 70:
        art_objects = [roll_2500_gp_art_object() for _ in range(random.randint(1, 10))]
        magic_items.extend([roll_magic_item_table_g() for _ in range(random.randint(1, 4))])
    elif gems_or_art_objects_roll == 71:
        art_objects = [roll_7500_gp_art_object() for _ in range(random.randint(1, 4))]
        magic_items.extend([roll_magic_item_table_g() for _ in range(random.randint(1, 4))])
    elif gems_or_art_objects_roll == 72:
        gems = [roll_5000_gp_gemstone() for _ in range(random.randint(1, 8))]
        magic_items.extend([roll_magic_item_table_g() for _ in range(random.randint(1, 4))])
    elif 73 <= gems_or_art_objects_roll <= 74:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        ...
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
        magic_items.extend([roll_magic_item_table_i() for _ in range(random.randint(1, 4))])
    elif 86 <= gems_or_art_objects_roll <= 90:
        art_objects = [roll_2500_gp_art_object() for _ in range(random.randint(1, 10))]
        magic_items.extend([roll_magic_item_table_i() for _ in range(random.randint(1, 4))])
    elif 91 <= gems_or_art_objects_roll <= 92:
        gems = [roll_1000_gp_gemstone() for _ in range(random.randint(3, 6))]
